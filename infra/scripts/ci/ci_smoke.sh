...
DUMMY_ENV=(
  ...
  -e BACKEND_SERVER_JOB_SECRET_KEY_CONTACT_TOKEN=smoke
  ...
  -e BACKEND_SERVER_JOB_AWS_ACCESS_KEY_ID=smoke
  -e BACKEND_SERVER_JOB_AWS_SECRET_ACCESS_KEY=smoke
  -e BACKEND_SERVER_JOB_AWS_REGION=eu-central-1
  -e BACKEND_SERVER_JOB_S3_BUCKET_NAME=smoke-bucket
  -e BACKEND_SERVER_JOB_S3_KMS_KEY_ID=alias/smoke-key
)
