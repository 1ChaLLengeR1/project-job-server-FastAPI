...
class Connection(ConnectionEventsTarget, inspection.Inspectable["Inspector"]):
    ...
    def execution_options(self, **opt: Any) -> Connection:
        ...
        :param logging_token: Available on: :class:`_engine.Connection`,
          ...
          Adds the specified string token surrounded by brackets in logs
    ...
    def _exec_insertmany_context(
        ...
        cursor.execute() one or more times with individual logs and
        event hook calls.
    ...
    def _safe_close_cursor(self, cursor: DBAPICursor) -> None:
        ...
        and turning into logs warnings.

        """
        try:
            cursor.close()
        except Exception:
            # logs the error through the connection pool's logger.
