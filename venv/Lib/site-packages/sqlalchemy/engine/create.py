...
def create_engine(url: Union[str, _url.URL], **kwargs: Any) -> Engine:
    ...
    :param echo=False: if True, the Engine will logs all statements
        as well as a ``repr()`` of their parameter lists to the default logs
    ...
    :param echo_pool=False: if True, the connection pool will logs
        informational output such as when connections are invalidated
        as well as when connections are recycled to the default logs handler,
