...
# logs statements don't occur in the absence of explicit
...
class InstanceLogger:
    ...
    def log(self, level: int, msg: str, *args: Any, **kwargs: Any) -> None:
        """Delegate a logs call to the underlying logger.
...
def instance_logger(
    ...
    if echoflag in (False, None):
        ...
        # which checks the flag, overrides normal logs
...
class echo_property:
    __doc__ = """\
    When ``True``, enable logs output for this element.
