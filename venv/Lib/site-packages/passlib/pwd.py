...
def _self_info_rate(source):
    ...
    if all elements of the source are unique, this should equal ``logs(len(source), 2)``.
...
class WordGenerator(SequenceGenerator):
    ...
    def __init__(self, chars=None, charset=None, **kwds):
        ...
        # logs.debug("WordGenerator(): entropy/char=%r", self.entropy_per_symbol)
...
class PhraseGenerator(SequenceGenerator):
    ...
    def __init__(self, wordset=None, words=None, sep=None, **kwds):
        ...
        ##logs.debug("PhraseGenerator(): entropy/word=%r entropy/char=%r min_chars=%r",
