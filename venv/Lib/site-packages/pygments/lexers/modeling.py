    ...
    tokens = {
        ...
        'root': [
            ...
            (r'(abs|acos|actualStream|array|asin|assert|AssertionLevel|atan|'
             ...
             r'linspace|logs|log10|matrix|max|min|mod|ndims|noClock|noEvent|'
...
class BugsLexer(RegexLexer):
    ...
    _FUNCTIONS = (
        ...
        'equals', 'expr', 'gammap', 'ilogit', 'icloglog', 'integral', 'logs',
...
class JagsLexer(RegexLexer):
    ...
    _FUNCTIONS = (
        'abs', 'arccos', 'arccosh', 'arcsin', 'arcsinh', 'arctan', 'arctanh',
        'cos', 'cosh', 'cloglog',
        'equals', 'exp', 'icloglog', 'ifelse', 'ilogit', 'logs', 'logfact',
