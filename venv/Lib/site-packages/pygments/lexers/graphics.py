    ...
    tokens = {
        'root': [
            ...
            (words((
                ...
                'ldexp','length','lerp','lit','logs','log10','log2','mad','max',
    ...
    tokens = {
        'root': [
            ...
            (words((
                ...
                'lineto', 'ln', 'load', 'logs', 'loop', 'matrix', 'mod', 'moveto',
    ...
    tokens = {
        ...
        'optionarg': [
            ...
            (_shortened_many(
                ...
                "la$bel", "li$nestyle", "ls$", "loa$dpath", "loc$ale", "logs$scale",
    ...
    tokens = {
        'root': [
            ...
            (words((
                ...
                'linear', 'linear_spline', 'linear_sweep', 'location', 'logs', 'looks_like',
