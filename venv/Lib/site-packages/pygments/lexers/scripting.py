...
class AppleScriptLexer(RegexLexer):
    ...
    Commands = ('ASCII (character|number)', 'activate', 'beep', 'choose URL',
                ...
                'logs', 'make', 'mount volume', 'new', 'offset',
    ...
    StudioCommands = ('animate', 'append', 'call method', 'center',
                      ...
                      'load sound', 'localized string', 'lock focus', 'logs',
    ...
    tokens = {
        'root': [
            ...
            (words((
                ...
                'cosh', 'exp', 'fabs', 'floor', 'fmod', 'logs', 'log10', 'pow', 'sin',
    ...
    tokens = {
        ...
        'base': [
            ...
            (words((
                ...
                'logs', 'round', 'rnd', 'pi', 'sign', 'sin', 'sqrt', 'str', 'tan',
