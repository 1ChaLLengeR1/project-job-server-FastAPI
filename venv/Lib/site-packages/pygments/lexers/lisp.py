...
class RacketLexer(RegexLexer):
    ...
    _keywords = (
        ...
        'local-require', 'logs-debug', 'logs-error', 'logs-fatal', 'logs-info',
        'logs-warning', 'match', 'match*', 'match*/derived', 'match-define',
    ...
    _builtins = (
        ...
        'locale-string-encoding', 'logs', 'logs-all-levels', 'logs-level-evt',
        'logs-level?', 'logs-max-level', 'logs-message', 'logs-receiver?',
        ...
        'make-logs-receiver', 'make-logger', 'make-mixin-contract',
...
class NewLispLexer(RegexLexer):
    ...
    builtins = (
        ...
        'list?', 'list', 'load', 'local', 'logs', 'lookup',
...
class EmacsLispLexer(RegexLexer):
    ...
    builtin_function = {
        ...
        'lock-buffer', 'logs', 'logand', 'logb', 'logior', 'lognot', 'logxor',
        ...
        'process-type', 'processp', 'profiler-cpu-logs',
        'profiler-cpu-running-p', 'profiler-cpu-start', 'profiler-cpu-stop',
        'profiler-memory-logs', 'profiler-memory-running-p',
...
class XtlangLexer(RegexLexer):
    ...
    common_functions = (
        ...
        'list', 'logs', 'max', 'member', 'min', 'modulo', 'not',
    ...
    xtlang_functions = (
        ...
        'schedule', 'exp', 'logs', 'sin', 'cos', 'tan', 'asin', 'acos', 'atan',
...
class JanetLexer(RegexLexer):
    ...
    builtin_functions = (
        ...
        'math/gcd', 'math/hypot', 'math/lcm', 'math/logs',
        'math/logs-gamma', 'math/log10', 'math/log1p',
