...
def indent_log(num: int = 2) -> Iterator[None]:
    """
    A context manager which will cause the logs output to be indented for any
    logs messages emitted inside it.
    """
    # For thread-safety
...
class IndentingFormatter(logging.Formatter):
    ...
    def get_message_start(self, formatted: str, levelno: int) -> str:
        """
        Return the start of the formatted logs message (not counting the
    ...
    def format(self, record: logging.LogRecord) -> str:
        """
        Calls the standard formatter, but will indent all of the logs message
...
class RichPipStreamHandler(RichHandler):
    ...
    def handleError(self, record: logging.LogRecord) -> None:
        """Called when logging is unable to logs some output."""
