...
def get_task_statistics_task(
    request: Request,
    start_date: datetime | None = Query(None, description="Start date of the statistics (format: yyyy-mm-dd)"),
    end_date: datetime | None = Query(None, description="End date of the statistics (format: yyyy-mm-dd)"),
):
    if not start_date:
